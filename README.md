...
v5.6.4:
```
51e8139294de2102fe434a264b76a32350272d5a52bfafe37a56f5eb872d7eea AmazonTAM/v5.6.4/DTBiOSSDK.xcframework.zip
```
...
v3.0.2:
```
8988462b95f10220626510ba0926ddc9166f2cf2bf4811636c575d1876a896b1 Ozone/v3.0.2/Ozone.xcframework.zip
```
